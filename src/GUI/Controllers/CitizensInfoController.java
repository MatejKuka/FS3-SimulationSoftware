...
public class CitizensInfoController implements Initializable {
    ...
    public void handleBasicInformation() throws UserException, IOException {
        ...
        loader.setLocation(getClass().getResource("/GUI/Views/CitizensViewBasicInfoView.fxml"));
        Parent root = loader.load();
        CitizensViewBasicInfoController citizenBasicInfoController = loader.getController();
